...
//            _bytes = new byte[entity.CalculateSize()];
...
//        [Benchmark]
//        public void UseEntityBufferedMessage()
//        {
//            //var bytes = ArrayPool<byte>.Shared.Rent(_bytes!.Length);
//            var owner = BufferedMessage.Create<EntityBufferedMessage>(_bytes!);
//            try
//            {
//                //_bytes.CopyTo(bytes, 0);
//                //var entity = new EntityBufferedMessage(new NativeBuffer(bytes, 0));
...
//        //[Benchmark]
//        //public void UseEntityBufferedMessage2()
//        //{
//        //    var bytes = _pool.Rent(_bytes!.Length);
//        //    //var owner = BufferedMessage.Create<EntityBufferedMessage>(_bytes!);
//        //    try
//        //    {
//        //        _bytes.CopyTo(bytes, 0);
//        //        //var entity = new EntityBufferedMessage(new NativeBuffer(bytes, 0));
//        //        var entity = EntityBufferedMessage.Parse(new NativeBuffer(bytes, 0));
//        //        //var entity = _bufferedMessage!;
//        //        Process(entity.Pritimive);
//        //        Process(entity.Unmanaged);
//        //        Process(entity.String);
