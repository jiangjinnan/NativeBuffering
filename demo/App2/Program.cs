...
//var context = new BufferedObjectWriteContext(bytes);
//context.WriteByteCount(byteCount);
...
//    {
//        var byteCountBytes = new byte[4];
//        fs.Read(byteCountBytes, 0, 4);
//        var byteCoount = BitConverter.ToInt32(byteCountBytes);

//        bufferOwner = BufferPool.Rent(byteCoount);
//        fs.Read(bufferOwner.Bytes, 4, byteCoount);
//    }
